    ...
    const movieDataArray = this.props.movieArray.map((mov, index) =>
      <div key={mov[0]}>
        ...
        <div className="movieLinks">
          <a href={"https://www.youtube.com/results?search_query=mst3k+" + mov[3]} target="_blank" rel="noopener noreferrer"><button className="youtubeLink">Check YouTube</button></a>
          <a href={"http://www.imdb.com/title/" + mov[7]} target="_blank" rel="noopener noreferrer"><button className="imdbLink">View IMDB</button></a>
        </div>
